...
const Context = ({ children }) => {
  ...
  const [errorEmail,setEmailErrore]=useState("")
  ...
  const[errorIsAccepted,setErrorIsAccepted]=useState("")
...
//         setEmailErrore('')
//       }else{
//         setEmailErrore("email not valid")
//       }


//     }else{
//       setEmailErrore("email requer")
//     }

//     if(data.password!==""){
//       if(data.password.length<6){
//         setErrorPassword("password bishtar az 6")
//       }else{
//         setErrorPassword("")
//       }

//     }else{
//       setErrorPassword("passwors requer")
//     }
...
//       }
//       else{
//         setErrorName("name requer")
//       }

//       if(data.confrimPassWord!==""){
//        if(data.password !== data.confrimpassword){
       
//         setErrorConfrimPassWord("Password do not match")
...
//       }else{
//         setErrorConfrimPassWord("Confirm the password")
//       }
//       if(data.isAccepted ){
...
//         setErrorIsAccepted("")
//       }else{
//         setErrorIsAccepted("Accept our regulations")
...
const validate = (data,type) => {
  ...
  if(data.email !==""){
    ...
    // setEmailErrore("email requer")
    setErrors.email("email requer")
  }

  if(data.password!==""){
    if(data.password.length<6){
      // setErrorPassword("password bishtar az 6")
      setErrors.password("password bishtar az 6")
    }else{
      // setErrorPassword("")
      setErrors.password("")
    }
    ...
    // setErrorPassword("passwors requer")
    setErrors.password("passwors requer")
  }
   ...
   if(type==="signup"){
    ...
    if(data.confrimPassWord!==""){
     if(data.password !== data.confrimpassword){
      ...
      // setErrorConfrimPassWord("Confirm the password")
      setErrors.confirmPassword("Confirm the password")
    }
    if(data.isAccepted ){
      console.log(isAccepted)

      // setErrorIsAccepted("")
      setErrors.isAccepted("")
    }else{
      // setErrorIsAccepted("Accept our regulations")
      setErrors.isAccepted("Accept our regulations")
